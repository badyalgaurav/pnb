angular.module('chatApp').directive('messageList', function ($rootScope, $anchorScroll, MessageService, ngNotify) {
  return {
    restrict: "E",
    replace: true,
    ...
    link: function(scope, element, attrs, ctrl) {
      ...
      var init = function(){
          ...
          element.bind("scroll", _.debounce(watchScroll,100));
      };
    ...
    controller: function($scope){
      // Auto scroll down is activacated when first loaded
